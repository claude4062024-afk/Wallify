        ...
        <section className="bg-background flex min-h-screen px-4 py-16 md:py-24">
            <div className="m-auto w-full max-w-xs">
                <div className="text-center">
                    <Link to="/" aria-label="go home" className="inline-block py-3">
                ...
                <div className="mt-6 space-y-3 border-t pt-6">
                    ...
                    >
                        {isGoogleLoading ? (
                            <span className="inline-flex size-4 animate-spin rounded-full border-2 border-foreground/30 border-t-foreground" />
                        ) : (
